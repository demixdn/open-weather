...
public final class FacebookLoginImpl implements FacebookCallback<LoginResult>, OnCompleteListener<AuthResult>, FacebookLogin {
    private final CallbackManager callbackManager;
    private final LoginManager loginManager;
    private final FirebaseAuth firebaseAuth;
    private WeakReference<LoginCallback> loginCallback;

    public FacebookLoginImpl(@NonNull FirebaseAuth firebaseAuth) {
